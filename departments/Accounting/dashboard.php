...
<div class="container my-4">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-4 text-end">
            ...
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#memoModal">+</button>
        </div>
    </div>
...
<div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="successModalLabel">Memo Sent Successfully</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
function filterMemos() {
    ...
    for (let i = 1; i < tr.length; i++) {
        let tdDescription = tr[i].getElementsByTagName("td")[0];
        let tdFrom = tr[i].getElementsByTagName("td")[1];
        let tdTo = tr[i].getElementsByTagName("td")[2];
        let tdDate = tr[i].getElementsByTagName("td")[3];
        let tdFile = tr[i].getElementsByTagName("td")[4];
...
<?php if ($showSuccessModal): ?>
    <script>
        // Trigger the modal to show after successful memo submission
