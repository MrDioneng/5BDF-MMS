...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $duration_minutes = intval($_POST['duration']); // Duration in minutes
    ...
    $stmt = $conn->prepare("INSERT INTO exams (exam_title, department, description, duration) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $exam_title, $department, $description, $duration_formatted);
...
<body>
  ...
  <main class="d-flex">
    ...
    <div class="container mt-4">
      <div class="row mb-3 align-items-center">
        <div class="col-md-4">
          <h2 class="m-0">Manage Exam</h2>
        </div>
        <div class="col-md-8 text-end">
          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addNewExam">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          ?>
              <tr>
                <td hidden><?php echo $row['exam_id']; ?></td>
                <td><?php echo $row['exam_title']; ?></td>
                <td><?php echo $row['department']; ?></td>
                <td><?php echo $row['description']; ?></td>
                <td><?php echo $row['duration']; ?></td>
                <td>
                  <a href="exam-items.php?exam_id=<?php echo $row['exam_id']; ?>" class="btn btn-sm btn-primary">Manage</a>
                  <a href="delete-exam.php?id=<?php echo $row['exam_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this exam?');">Delete</a>
                </td>
              </tr>
          <?php
            }
          } else {
            echo '<tr><td colspan="6" class="text-center">No exams available.</td></tr>';
          }
          ?>
        </tbody>
      </table>
  ...
  <!-- Add New Exam Modal -->
<div class="modal fade" id="addNewExam" tabindex="-1" aria-labelledby="addNewExamLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    
      <div class="modal-header">
        <h5 class="modal-title" id="addNewExamLabel">Add New Exam</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      
      <form action="manage-exams.php" method="POST">
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="examDescription" name="description" required>
          </div>
          <div class="mb-3">
